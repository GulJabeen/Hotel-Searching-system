...
<link href="deletereservation.css" rel="stylesheet" type="text/css" />
</head>
...
<form id="form1" name="form1" method="post"    action="deletereservationaction.php">
  <p>&nbsp;</p>
  <span class="labelinsert">
 
  
  </span>
  <p>Delete Reservation</br>
    <?php
...
?>
  ...
  <p>
    <input name="button" type="submit" class="BUTTONinsert" id="button" value="Delete" />
  </div>
  </p>
  <p></p>
  <p></p>
